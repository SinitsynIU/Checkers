...
//MARK: light WHITE (right top)
        for view in viewBoard.subviews {
            if checker.backgroundColor == .white, (view.tag == (checkerSquare.tag + 18)) {
                ...
                if checker.backgroundColor == .white, (view.tag == (checkerSquare.tag + 4)) {
                    if view.subviews.isEmpty, view.backgroundColor != .white,
                    ...
                    if checker.backgroundColor == .white, (view.tag == (checkerSquare.tag + 32)) {
                        if view.subviews.isEmpty, view.backgroundColor != .white,
                        ...
                        if checker.backgroundColor == .white, (view.tag == (checkerSquare.tag + 36)) {
                            if view.subviews.isEmpty, view.backgroundColor != .white,
                            ...
                            if checker.backgroundColor == .white, (view.tag == (checkerSquare.tag + 54)) {
                                if view.subviews.isEmpty, view.backgroundColor != .white,
                        ...
                        if checker.backgroundColor == .white, (view.tag == (checkerSquare.tag + 22)) {
                            if view.subviews.isEmpty, view.backgroundColor != .white,
                        ...
                        if checker.backgroundColor == .white, (view.tag == (checkerSquare.tag + 50)) {
                            if view.subviews.isEmpty, view.backgroundColor != .white,
...
//MARK: light WHITE (left top)
                        ...
                        if checker.backgroundColor == .white, (view.tag == (checkerSquare.tag + 14)) {
                            ...
                            if checker.backgroundColor == .white,(view.tag == (checkerSquare.tag + 28)) {
                                if view.subviews.isEmpty, view.backgroundColor != .white,
                                ...
                                if checker.backgroundColor == .white, (view.tag == (checkerSquare.tag + 42)) {
                            ...
                            if checker.backgroundColor == .white, (view.tag == (checkerSquare.tag + 10)) {
                                if view.subviews.isEmpty, view.backgroundColor != .white,
                                ...
                                if checker.backgroundColor == .white, (view.tag == (checkerSquare.tag + 46)) {
...
//MARK: light WHITE (left bottom)
                    ...
                    if checker.backgroundColor == .white, (view.tag == (checkerSquare.tag + 7)) {
        ...
        if checker.backgroundColor == .white, (view.tag == (checkerSquare.tag + 9)) {
            if view.backgroundColor != .white, view.subviews.isEmpty,
               ((filterEighteenBottom.first(where: {$0.subviews.isEmpty}) == nil || filterNineBottom.first?.subviews.first?.backgroundColor != .gray) || filterNineBottom.first(where: {$0.subviews.isEmpty}) != nil) &&
                (filterFourteenBottom.first(where: {$0.subviews.isEmpty}) == nil || filterSevenBottom.first?.subviews.first?.backgroundColor != .gray || filterSevenBottom.first(where: {$0.subviews.isEmpty}) != nil) &&
...
//                                                                                    }
                        ...
                        if (view.tag == (checkerSquare.tag - 46)) {
                            if view.subviews.isEmpty, view.backgroundColor != .white,  filterFourteenBottom.first(where: {$0.subviews.isEmpty}) != nil && filterTwentyEightBottom.first(where: {$0.subviews.isEmpty}) != nil && filterFortySixBottom.first(where: {$0.subviews.isEmpty}) != nil && filterSevenBottom.first?.subviews.first?.backgroundColor == .white && filterTwentyOneBottom.first?.subviews.first?.backgroundColor == .white && filterThirtySevenBottom.first?.subviews.first?.backgroundColor == .white {
                                    view.layer.borderColor = UIColor.green.cgColor
                                    view.layer.borderWidth = 3
                                    }
                    } else {
                        ...
                        if checker.backgroundColor == .gray, view.tag == (checkerSquare.tag - 7) {
                            ...
                            ((filterFourteenTop.first(where: {$0.subviews.isEmpty}) == nil || filterSevenTop.first?.subviews.first?.backgroundColor != .white) || filterSevenTop.first(where: {$0.subviews.isEmpty}) != nil) && ((filterEighteenBottom.first(where: {$0.subviews.isEmpty}) == nil || filterNineBottom.first?.subviews.first?.backgroundColor != .white) || filterNineBottom.first(where: {$0.subviews.isEmpty}) != nil || filterEighteenBottom.first?.backgroundColor == .white) && ((filterEighteenTop.first(where: {$0.subviews.isEmpty}) == nil || filterNineTop.first?.subviews.first?.backgroundColor != .white) || filterNineTop.first(where: {$0.subviews.isEmpty}) != nil) {
                                ...
                                if checker.backgroundColor == .gray, view.tag == (checkerSquare.tag - 9) {
